...
class Sensor {
 public:
  ...
  //-------------
  // added by LIUQ
  bool WriteSensorFile(const std::string& filename);
  void Reset();
  void Fill();
  void Write();
 private:
  ...
  std::vector<double> qhit;
  std::vector<double> thit;
  std::vector<double> dthit;
  std::vector<double> xhit;
  std::vector<double> yhit;
  std::vector<double> zhit;
  std::vector<double> vxhit;
  std::vector<double> vyhit;
  std::vector<double> vzhit;
